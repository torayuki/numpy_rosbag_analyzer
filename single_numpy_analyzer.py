...
from audio_utils import sound_postprocess, save_wav, waveform_normalize
...
def main():
    ...
    results_path = "result/2022-04-07"
    ...
    for numpy_dir in tqdm(numpy_dir_list):
        ...
        obs_wav = sound_postprocess(observations["sound"], library="librosa", device=device)
        save_wav(waveform_normalize(obs_wav), obs_wavame, sr=16000)
